...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs+1):
        ...
        if iter % args.test_freq==args.test_freq-1 or iter>=args.epochs-10:
            ...
            if iter != args.epochs:
                print('Round {:3d}, Total Time {:.3f}, Train loss: {:.3f}, Test loss: {:.3f}, Test accuracy: {:.2f}'.format(
                        iter, running_time_total, loss_avg, loss_test, acc_test))
            else:
                ...
                print('Final Round, Total Time {:.3f}, Train loss: {:.3f}, Test loss: {:.3f}, Test accuracy: {:.2f}'.format(
                        running_time_total, loss_avg, loss_test, acc_test))
